...
public class ProcessInstanceQuery {
    ...
    private ProcessInstanceDao processInstanceDaoImpl;
    ...
    public ProcessInstanceEntity SingleResult() {
        ...
        ArrayList<ProcessInstanceEntity> arrayList = processInstanceDaoImpl.findProcessInstance(processInstanceEntity);
    ...
    public ArrayList<ProcessInstanceEntity> getAllProcessInstance() {
        ...
        return processInstanceDaoImpl.getAllProcessInstance();
    }
