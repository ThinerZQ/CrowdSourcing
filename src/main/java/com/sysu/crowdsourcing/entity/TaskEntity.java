...
public class TaskEntity {
    ...
    @OneToMany(cascade = CascadeType.ALL)
    @JoinColumn(name = "task_id")
    public Set<MergetaskEntity> mergetaskEntitySet = new HashSet<MergetaskEntity>();

    @OneToMany(cascade = CascadeType.ALL)
    @JoinColumn(name = "task_id")
    public Set<QualificationEntity> qualificationEntitySet = new HashSet<QualificationEntity>();
