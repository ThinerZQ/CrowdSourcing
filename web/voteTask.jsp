    ...
    <div class="row">
        <div class="container">
            <ul id="myTab" class="nav nav-tabs">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/voteTask.do">投票任务</a></li>
            ...
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade in active" id="home">
                    <c:choose>
                        <c:when test="${not empty votetaskEntityList}">

                            <c:forEach items="${votetaskEntityList }" var="voteTaskEntity">

                                <div class="panel panel-primary panel-info">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><c:out
                                                value="${voteTaskEntity.taskEntity.title}"></c:out></h3>
                                    </div>
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                发布者：<span><c:out
                                                    value="${voteTaskEntity.userEntity.userName}"></c:out></span>
                                            </div>
                                            <div class="col-lg-6 text-right">
                                                过期时间：
                                                <span><c:out value="${voteTaskEntity.deadlineTime}"></c:out></span>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <c:forEach items="${voteTaskEntity.taskEntity.descriptionEntitySet}"
