    ...
    <div class="row">
        <div class="container">
            <ul id="myTab" class="nav nav-tabs">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/solveTask.do">解决任务</a></li>
            ...
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade in active" id="home">
                    <c:choose>
                        <c:when test="${not empty solvetaskEntityList}">

                            <c:forEach items="${solvetaskEntityList }" var="solveTaskEntity">

                                <div class="panel panel-primary panel-info">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><c:out
                                                value="${solveTaskEntity.taskEntity.title}"></c:out></h3>
                                    </div>
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                发布者：<span><c:out
                                                    value="${solveTaskEntity.userEntity.userName}"></c:out></span>
                                            </div>
                                            <div class="col-lg-6 text-right">
                                                过期时间：
                                                <span><c:out value="${solveTaskEntity.deadlineTime}"></c:out></span>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <c:forEach items="${solveTaskEntity.taskEntity.descriptionEntitySet}"
