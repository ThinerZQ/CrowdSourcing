...
public abstract class TransitionalState extends EnterableState {
     ...
     */
    @Override
    public com.sysu.workflow.model.TransitionalState getParent() {
        return (com.sysu.workflow.model.TransitionalState) super.getParent();
    }
     ...
     */
    public final void setParent(final com.sysu.workflow.model.TransitionalState parent) {
     ...
     */
    @Override
    public com.sysu.workflow.model.TransitionalState getAncestor(int level) {
        return (com.sysu.workflow.model.TransitionalState) super.getAncestor(level);
    }
