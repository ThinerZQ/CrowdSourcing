...
public class SCXMLExecutor implements SCXMLIOProcessor {
     ...
     * SCXMLExecutor的日志记录器
     */
    private Log log = LogFactory.getLog(com.sysu.workflow.SCXMLExecutor.class);
    /**
     * Parent SCXMLExecutor
     * <p/>
     * 父SCXMLExecutor
     */
    private com.sysu.workflow.SCXMLExecutor parentSCXMLExecutor;
    /**
     ...
     */
    public SCXMLExecutor(final com.sysu.workflow.SCXMLExecutor parentSCXMLExecutor) {
     ...
     */
    protected com.sysu.workflow.SCXMLExecutor getParentSCXMLExecutor() {
