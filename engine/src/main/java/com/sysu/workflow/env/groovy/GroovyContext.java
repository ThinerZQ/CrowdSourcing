...
public class GroovyContext extends SimpleContext {
    ...
    private static final Log log = LogFactory.getLog(com.sysu.workflow.env.groovy.GroovyContext.class);
    ...
    protected String getScriptBaseClass() {
        ...
        if (getParent() instanceof com.sysu.workflow.env.groovy.GroovyContext) {
            return ((com.sysu.workflow.env.groovy.GroovyContext) getParent()).getScriptBaseClass();
        }
        return null;
    }
