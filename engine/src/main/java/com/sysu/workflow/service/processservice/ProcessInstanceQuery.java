...
public class ProcessInstanceQuery {
    ...
    public com.sysu.workflow.service.processservice.ProcessInstanceQuery processInstanceId(String id) {
        processInstanceEntity.setProcessInstanceId(id);
        return this;
    }

    public com.sysu.workflow.service.processservice.ProcessInstanceQuery userId(String processInstanceName) {
