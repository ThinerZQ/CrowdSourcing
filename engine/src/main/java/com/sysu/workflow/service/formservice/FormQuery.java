...
public class FormQuery {
    ...
    public com.sysu.workflow.service.formservice.FormQuery formSrc(String formSrc) {
        formEntity.setFormSrc(formSrc);
        return this;
    }

    public com.sysu.workflow.service.formservice.FormQuery formId(long formId) {
        formEntity.setFormId(formId);
        return this;
    }

    public com.sysu.workflow.service.formservice.FormQuery formName(String formName) {
