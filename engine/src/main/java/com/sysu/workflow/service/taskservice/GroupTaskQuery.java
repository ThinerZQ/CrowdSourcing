...
public class GroupTaskQuery {
    ...
    public com.sysu.workflow.service.taskservice.GroupTaskQuery taskName(String taskName) {
        groupWorkItemEntity.setItemName(taskName);
        return this;
    }

    public com.sysu.workflow.service.taskservice.GroupTaskQuery taskId(int taskId) {
        groupWorkItemEntity.setItemId(taskId);
        return this;
    }

    public com.sysu.workflow.service.taskservice.GroupTaskQuery taskProcessInstanceId(String taskProcessInstanceId) {
        groupWorkItemEntity.setItemProcessId(taskProcessInstanceId);
        return this;
    }

    public com.sysu.workflow.service.taskservice.GroupTaskQuery taskStateId(String taskStateId) {
        groupWorkItemEntity.setItemStateId(taskStateId);
        return this;
    }

    public com.sysu.workflow.service.taskservice.GroupTaskQuery taskCandidateGroup(GroupEntity groupEntity) {
