...
public class SCXMLExecutionContext implements SCXMLIOProcessor {
     ...
     */
    private final com.sysu.workflow.SCXMLExecutor scxmlExecutor;
    /**
     * 内部事件队列
     ...
     */
    private Log appLog = LogFactory.getLog(com.sysu.workflow.SCXMLExecutionContext.class);
    /**
     * SCInstance实例
     * The SCInstance.
     */
     ...
     */
    protected SCXMLExecutionContext(com.sysu.workflow.SCXMLExecutor scxmlExecutor, Evaluator evaluator,
