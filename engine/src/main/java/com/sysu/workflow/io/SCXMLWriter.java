...
public class SCXMLWriter {
    ...
    private static void writeNode(final XMLStreamWriter writer, final Node node)
        ...
        try {
            ...
            org.apache.commons.logging.Log log = LogFactory.getLog(com.sysu.workflow.io.SCXMLWriter.class);
     ...
     * {@link com.sysu.workflow.io.SCXMLWriter}. Exactly one of the stream, writer or result parameters must be provided.
     *
     * @param configuration The {@link Configuration} to use.
    ...
    /**
     * <p>
     * Configuration for the {@link com.sysu.workflow.io.SCXMLWriter}. The configuration properties necessary for the following are
     * covered:
     * </p>
     * <p/>
     * <ul>
