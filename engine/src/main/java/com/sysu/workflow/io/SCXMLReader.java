...
public final class SCXMLReader {
   ...
   /* private SCXMLReader() {
    ...
    private static void readTransitionalStateSrc(final Configuration configuration, final String src,
        ...
        SCXML externalSCXML;
        try {
            externalSCXML = readInternal(configuration, new URL(location), null, null, null, null);
        } catch (Exception e) {
    ...
    private static void readCustomAction(final XMLStreamReader reader, final Configuration configuration,
        ...
        if (cl == null) {
            cl = com.sysu.workflow.io.SCXMLReader.class.getClassLoader();
        }
        Class<?> clazz;
        try {
    ...
    private static String readBody(final XMLStreamReader reader)
        ...
        while (reader.hasNext()) {
            switch (reader.next()) {
                case XMLStreamConstants.START_ELEMENT:
                    log = LogFactory.getLog(com.sysu.workflow.io.SCXMLReader.class);
    ...
    private static void reportIgnoredElement(final XMLStreamReader reader, final Configuration configuration,
        ...
        org.apache.commons.logging.Log log = LogFactory.getLog(com.sysu.workflow.io.SCXMLReader.class);
     ...
     * {@link com.sysu.workflow.io.SCXMLReader}. Exactly one of the url, path, stream, reader or source parameters must be provided.
     *
    ...
    /**
     * <p>
     * Configuration for the {@link com.sysu.workflow.io.SCXMLReader}. The configuration properties necessary for the following are
     * covered:
     * </p>
     * <p/>
     * <ul>
